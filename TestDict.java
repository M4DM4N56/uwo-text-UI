...
public class TestDict {
	...
	try {
	    ...
	    else System.out.println("Test 01 failed<-");
	}
	catch(Exception e) {
	...
	try {
	    ...
	    if (rec == null) System.out.println("Test 02 passed");
	    else System.out.println("Test 02 failed<-");
	}
	catch(Exception e) {
	...
	try {
	    ...
	    rec = dictionary.get(keys[1]);
	    if (rec == null) System.out.println("Test 04 passed");
	    else System.out.println("Test 04 failed<-");
	}
	catch(DictionaryException e) {
	...
	try {
	    ...
	    else System.out.println("Test 06 failed<-");
	}
	catch (Exception e) {
	...
	try {
	    ...
	    else System.out.println("Test 07 failed<-");
	}
	catch (Exception e) {
	...
	try {
	    ...
	    else System.out.println("Test 08 failed<-");
	}
	catch (Exception e) {
	...
	try {
	    ...
	    else System.out.println("Test 09 failed<-");
	}
	catch (Exception e) {
